...
const Map = dynamic(() => import('../lib/dynamic-maps'),
{ ssr: false 
});
       ...
       <div className='flex flex-col gap-8'>
        <div className='flex flex-row gap-4'>
            <div className='before:absolute before:w-12 before:h-12 before:bg-orange-800 before:rounded-full before:blur-xl before:top-16 relative flex flex-col justify-around items-center w-20 h-24  md:w-44 md:h-44 rounded-2xl shadow-inner shadow-gray-50 bg-neutral-900 text-gray-50'>
                <Image src={markerShadow} alt='' width={100} height={100} className='w-30 h-30' />
                <h1>hello</h1>
            </div>
            <div className='before:absolute before:w-12 before:h-12 before:bg-orange-800 before:rounded-full before:blur-xl before:top-16 relative flex flex-col justify-around items-center w-20 h-24  md:w-44 md:h-44 rounded-2xl shadow-inner shadow-gray-50 bg-neutral-900 text-gray-50'>
                  <Image src={relocationMarker} alt='' width={100} height={100} className='w-30 h-30' />
                <h1>hello</h1>
            </div>
            <div className='before:absolute before:w-12 before:h-12 before:bg-orange-800 before:rounded-full before:blur-xl before:top-16 relative flex flex-col justify-around items-center w-20 h-24  md:w-44 md:h-44 rounded-2xl shadow-inner shadow-gray-50 bg-neutral-900 text-gray-50'>
                  <Image src={workMarker} alt='' width={100} height={100} className='w-30 h-30' />
                <h1>hello</h1>
            </div>
        </div>
           <hr />
        ...
        <div className='pageWrapper'>
            <div className='boxSection'>
                <div className='relative flex w-80 flex-col rounded-xl bg-white bg-clip text-gray-700 shadow-md'>
                        <div  onClick={openModal} className='relative mx-4 -mt-4  overflow-hidden rounded-xl h-60 bg-stone-700 bg-clip-border text-white shadow-lg shadow-stone-500/40 bg-gradient-to-r from-stone-600 to-stone-700 duration-300 hover:-translate-y-1 hover:scale-110 transition ease-in-out delay-150 cursor-pointer hover:border-blue-300  hover:border'>
                            <Image src='/imgs/mapsanimation.gif' width={100} height={100} alt='Map' className='w-[288px] h-[240px]'  />
                        </div>
                         {isModalOpen && (
                             <Modal
                     isOpen={isModalOpen}
