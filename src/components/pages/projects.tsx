...
import {  Accordion,
  AccordionContent,
  AccordionItem,
  AccordionTrigger, } from '../lib/accordion';
...
const ProjectFont = LocalFonts({ src: '../../fonts/subFont/new-york-small-regular.woff2'})
                        ...
                        {PROJECT_LIST.map(( feature, idx) => (
                            <AccordionItem key={idx} value={feature.slug}>
                                <AccordionTrigger>
                                        ...
                                        <h3 className={`text-base text-gray-600 ${ProjectFont.className}`}>
                                ...
                                <AccordionContent>
                                    <div className='p-3'>
                                        <p className={`mb-4 text-sm text-gray-500 ${ProjectFont.className}`}>
                                            {feature.description}
                                        </p>
                                        <div className='flex space-x-3'>
                                            <Link href={feature.siteUrl}
                                    ...
                                    if (index === activeFeature) {
                                        return (
                                            <motion.div
                                                ...
                                                exit={{ y: -10, opacity: 0, }}
                                                transition={{ duration: 0.15, stiffness: 300, damping: 30, }}
