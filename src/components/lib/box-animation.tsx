        ...
        <div ref={ref} className='[perspective:2000px]'>
            ...
            >               
                ...
                <div className='flex space-x-3 p-2'>
                  <p>
                    <span className='text-base text-purple-600 dark:text-fuchsia-500'>→</span>
                    <span className='mx-1 text-green-600 dark:text-green-400'>~/workspace</span>
                    <span>$</span>
                  </p>
                  <p className='typing mt-0.5 flex-1 pl-2'>npx create-nx-workspace</p>
                </div>
