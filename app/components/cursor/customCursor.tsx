...
import arrowIcon from "../../../public/imgs/arrow-right-light.svg"
...
export default function CustomCursor() {
  ...
  return (
    <div
      ref={trailerRef}
      className="pointer-events-none invisible fixed left-1/2 top-1/2 z-40 flex items-center justify-center rounded-full bg-[#75d5b9] opacity-0 will-change-transform md:visible"
    >
      <Image
        id="icon"
        src={arrowIcon}
